...
function estimateSize(mnemonic: string, operands: string[], equ: Map<string, string>): number {
  ...
  switch (mnemonic) {
    ...
    case "cjne":
      ...
      if (isRegisterToken(arg0) || arg0 === "a" || arg0 === "acc" || arg0 === "@r0" || arg0 === "@r1") return 3;
      if (arg1.startsWith("#") && resolveNumber(arg0, equ) != null) return 5;
      return 3;
    case "djnz":
      if (operands.length !== 2) return 0;
